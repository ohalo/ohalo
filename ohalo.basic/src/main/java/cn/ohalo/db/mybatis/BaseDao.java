...
import cn.ohalo.db.mybatis.persistence.AbstractBaseDao;
import cn.ohalo.db.mybatis.persistence.IBaseDAO;
import cn.ohalo.utils.FunIMsgFormat;
...
public abstract class BaseDao<T, ID> extends AbstractBaseDao implements
	...
	public Integer count(String[] propertyNames, Object... propertyValues)
		...
		BigDecimal cout = (BigDecimal) getSqlSession().selectOne(
