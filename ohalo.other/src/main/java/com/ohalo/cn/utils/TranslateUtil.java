...
public class TranslateUtil {
	...
	public static void main(String[] args) throws Exception {
		String msg = TranslateUtil
				.translate("nice to meet you", ENGLISH, CHINA);
		String chinaMsg = TranslateUtil.translate("这件事是这么搞的吗？", CHINA, ENGLISH);
		System.out.print(msg + "," + chinaMsg);
	}
