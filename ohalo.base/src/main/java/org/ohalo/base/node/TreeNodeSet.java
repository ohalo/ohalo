 ...
 * @version 2013-9-9 下午2:33:31
 */
public class TreeNodeSet extends TreeNode {

	private static final long serialVersionUID = 2544265242831973399L;
	...
	public TreeNodeSet(boolean isAsc) {
		super();
		this.children = new TreeSet<TreeNode>(new TreeNodeComparator(isAsc));
	}

	public TreeNodeSet(String id, String pid, Map<String, Object> data) {
		super(id, pid, data);
		this.children = new TreeSet<TreeNode>(new TreeNodeComparator());
	}
	...
	public TreeNodeSet(String id, String pid, Map<String, Object> data,
		...
		super(id, pid, data);
		this.children = (children == null) ? (new TreeSet<TreeNode>(
				new TreeNodeComparator())) : children;
	...
	public TreeNodeSet(String id, String pid, Map<String, Object> data,
			Set<TreeNode> children, boolean isAsc) {
		super(id, pid, data);
		this.children = (children == null) ? (new TreeSet<TreeNode>(
				new TreeNodeComparator(isAsc))) : children;
		if (children != null && children.size() != 0) {
			this.leaf = false;
		} else {
			this.leaf = true;
