 ...
 */
class GCanvas extends JComponent implements Printable, LayoutManager,
		MouseListener, MouseMotionListener, ComponentListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = 646719767217767634L;
	...
	/**
	 * Override the JPanel default to indicate that this canvas is double
	 * buffered.
	 * 
	 * @return True always.
	 */
	...
	/**
	 * Override the JPanel default repaint method and do nothing. TODO: Check
	 * this.
	 */
	public void repaint() {
	}
	...
	/**
	 * Override the JPanel update method and do nothing. TODO: Check this.
	 * 
	 * @param graphics
	...
	/**
	 * Create a new image back buffer. The back buffes has the size of the cnvas
	 * and is recreated each time the canvas size changes (on resize events).
	 */
	...
	/**
	 * Paint this component by copying the back buffer into the front buffer.
	 * 
	 * @param graphics
	 *            The Java2D graphics instance.
	 */
	public void paintComponent(Graphics graphics) {
		...
		frontBuffer.drawImage(backBuffer_, cleared_.x, cleared_.y,
				cleared_.width, cleared_.height, cleared_.x, cleared_.y,
				cleared_.width, cleared_.height, this);

		// TODO: These work as well. Which method is better?
		// frontBuffer.drawImage (backBuffer_, 0, 0, getWidth(), getHeight(),
		// this);
	 ...
	 * 
	 * @param rectangle
	 *            Rectangle area to clear in the back buffer.
	 */
	void clear(Rect rectangle) {
		...
		canvas.setColor(getBackground());
		canvas.fillRect(rectangle.x, rectangle.y, rectangle.width,
				rectangle.height);
	}
	 ...
	 * 
	 * @param region
	 *            Region to use as clip area.
	 */
	void setClipArea(Region region) {
		clipArea_ = region == null || region.isEmpty() ? null : region
				.createArea();
	}

	/**
	 * Render the specified polyline into back buffer using the specified style.
	 * 
	 * @param x
	 *            Polyline x coordinates.
	 * @param y
	 *            Polyline y coordinates.
	 * @param style
	...
	void render(int x[], int y[], GStyle style) {
		...
		canvas.setRenderingHint(RenderingHints.KEY_ANTIALIASING, style
	...
	/**
	 * Render the specified text element into back buffer using the specified
	 * style.
	 * 
	 * @param text
	 *            Text to render.
	...
	void render(GText text, GStyle style) {
		...
		canvas.setRenderingHint(RenderingHints.KEY_TEXT_ANTIALIASING, style
	...
	/**
	 * Render the specified image at every vertex along the specified polyline.
	 * 
	 * @param x
	 *            Polyline x components.
	 * @param y
	 *            Polyline y components.
	 * @param image
	 *            Image to render.
	 */
	...
	/**
	 * Utility method for computing the rectangle bounding box of a rendered
	 * string using the specified font.
	 * 
	 * @param string
	 *            Sample string.
	 * @param font
	 ...
	 * are positined at thir specified x, y location as determined by the
	 * GAnnotator.
	 * 
	 * @param container
	 *            Container to layout.
	 ...
	 * 
	 * @param container
	 *            Component to return minimum layout size of.
	 ...
	 * 
	 * @param container
	 *            Component to return maximum layout size of.
	 * @return Size of canvas window.
	 */
	 ...
	 * 
	 * @param event
	 *            Mouse event trigging this method.
	 */
