 ...
 * GComponent). It is optional, and when unset the style of the parent component
 * is applied. This is also the case for the individual properties of the
 * GStyle.
 * <p>
 * Example:
 * 
...
public class GStyle implements Cloneable {
	...
	public Object clone() {
		...
		if (foregroundColor_ != null) {
			style.foregroundColor_ = new Color(foregroundColor_.getRed(),
					foregroundColor_.getGreen(), foregroundColor_.getBlue(),
		...
		if (backgroundColor_ != null) {
			style.backgroundColor_ = new Color(backgroundColor_.getRed(),
					backgroundColor_.getGreen(), backgroundColor_.getBlue(),
		...
		style.font_ = null;
		if (font_ != null) {
			style.font_ = new Font(font_.getName(), font_.getStyle(),
					font_.getSize());
		}
	...
	/**
	 * Update this style based on specified style. Style elements explicitly set
	 * in the specified style is copied to this style, other elements are
	 * ignored.
	 * 
	 * @param style
	 *            Style to update with.
	 */
	void update(GStyle style) {
		...
		if (style.isValid(MASK_FILLPATTERN)) {
			if (style.fillData_ != null)
				setFillPattern(style.fillWidth_, style.fillHeight_,
						style.fillData_);
			else
	 ...
	 * 
	 * @param validMask
	 *            Identifier of style element to set (MASK_...)
	 */
	 ...
	 * 
	 * @param validMask
	 *            Identifier of style element to invalidate (MASK_...)
	 */
	 ...
	 * 
	 * @param validMask
	 *            Identifier of style element to check (MASK_...)
	...
	/**
	 * Return the current foreground color of this style. The element is not in
	 * use if it is invalid.
	 * 
	...
	/**
	 * Return current background color of this style. The element is not in use
	 * if it is invalid.
	 * 
	...
	/**
	 * Return current line width of this style. The element is not in use if it
	 * is invalid.
	 * 
	...
	/**
	 * Return current font of this style. The element is not in use if it is
	 * invalid.
	 * 
	...
	/**
	 * Return current line end cap style of this style. The element is not in
	 * use if it is invalid.
	 * 
	...
	/**
	 * Set line end join style of this style. One of BasicStroke.JOIN_BEVEL,
	 * BasicStroke.JOIN_MITTER or BasicStroke.JOIN_ROUND (default).
	 * 
	 * @param joinStyle
	 *            New join style.
	 */
	...
	/**
	 * Return current join style of this style. The element is not in use if it
	 * is invalid.
	 * 
	 ...
	 * 
	 * @param isAntialiased
	 *            Antialiasing on (true) or off (false) (default).
	 */
	...
	/**
	 * Return current antialiasing setting of this style. The element is not in
	 * use if it is invalid.
	 * 
	 ...
	 *            Tile height.
	 * @param data
	 *            Pattern data (0s and 1s indicating set/unset).
	 */
	...
	/**
	 * Set image as fill pattern. TODO: Cache the file name and create the image
	 * lazy
	 * 
	 * @param fileName
	 *            File name of image.
	...
	/**
	 * Set custom line style. Dash pattern consists of and array of leg lengths
	 * of line on and line off respectively.
	 * 
	 * @param dashPattern
	 *            New dash pattern.
	 */
	public void setLineStyle(float dashPattern[]) {
		...
		if (dashPattern != null) {
			...
			System.arraycopy(dashPattern, 0, dashPattern_, 0,
					dashPattern.length);
			isLineVisible_ = true;
		} else
			dashPattern_ = null;
	...
	/**
	 * Return current line style of this style. The element is not in use if it
	 * is invalid.
	 * 
	...
	Paint getPaint() {
		...
		if (paint_ == null && fillPattern_ != null) {
			paint_ = new TexturePaint(fillPattern_, new Rectangle(0, 0,
					fillWidth_, fillHeight_));
		}

		// TODO: Gradient color is not currently in use
		else if (paint_ == null && gradientColor1_ != null) {
			paint_ = new GradientPaint((float) -100.0, (float) 0.0,
					gradientColor1_, (float) 100.0, (float) 0.0,
					gradientColor2_, true);
	...
	/**
	 * Check if line is visible. Line is invisible if line style is set to
	 * invisible.
	 * 
	 ...
	 * 
	 * @return Return true if objects using this style appear as filled, false
	 *         otherwise.
	 */
	boolean isDefiningFill() {
		return fillPattern_ != null || fillData_ != null
				|| backgroundColor_ != null;
	}
	...
	/**
	 * Add a listener to this style. When the style is changed, a styleChanged()
	 * signal is sent to the listener.
	 * 
	 * @param listener
	 *            Style listener to add.
	 */
