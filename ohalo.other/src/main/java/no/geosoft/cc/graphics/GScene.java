...
public class GScene extends GObject {
	...
	/**
	 * Create a scene within the specified window. For most practical purposes a
	 * window will contain one scene only.
	 * <p>
	 * A default viewport will be established covering the entire window. This
	 * is appropriate in most cases.
	 * <p>
	 * A default world-extent will be established with coordinates equal to the
	 * window device extent. This may be sufficient in many cases if object
	 * geometry is specified in device coordinates.
	 * 
	 * @param window
	 *            Window to attach this scene to.
	 * @param name
	 *            Name of this scene.
	 */
	 ...
	 * 
	 * @param window
	 *            Window to acttach this scene to.
	 */
	...
	/**
	 * Return the window of this scene. A scene is always attached to a window,
	 * a GObject is not necesserily.
	 * 
	...
	/**
	 * Specified if one should zoom on resize. Set to true, the current image
	 * will change size (i.e. zoomed). Set to false the current image will be
	 * the same size and one will possibley see more or less instead. Default is
	 * true.
	 * 
	 * @param shouldZoomOnResize
	 *            True if world extent should be unchanged on resize, false
	 *            otherwise.
	 */
	 ...
	 * 
	 * @param shouldWorldExtentFitViewport
	 *            True if the world extent should fit the viewport, false
	 *            otherwise.
	 */
	public void shouldWorldExtentFitViewport(
			boolean shouldWorldExtentFitViewport) {
	 ...
	 * 
	 * @param x0
	 *            X coordinate of upper left corner of viewport.
	 * @param y0
	 *            Y coordinate of upper left corner of viewport.
	 * @param width
	 *            Width of viewport.
	 * @param height
	 *            Height of viewport.
	 ...
	 * 
	 * @param w0
	 *            Point 0 of the new world extent [x,y,z].
	 * @param w1
	 *            Point 1 of the new world extent [x,y,z].
	 * @param w2
	 *            Point 2 of the new world extent [x,y,z].
	 */
	...
	/**
	 * A convenience method for specifying a orthogonal world extent in the Z=0
	 * plane. The layout is as follows:
	 * 
	 * <pre>
	 *           o 
	 *           |
	 ...
	 * 
	 * @param x0
	 *            X coordinate of world extent origin.
	 * @param y0
	 *            Y coordinate of world extent origin.
	 * @param width
	 *            Width of world extent.
	 * @param height
	 *            Height of world extent.
	 */
	...
	private void updateRegion() {
		if (viewport_.isSkewed()) {
			...
			Rect rectangle = new Rect(viewport_.getX0(), viewport_.getY0(),
					(int) viewport_.getWidth(), (int) viewport_.getHeight());
	 ...
	 * <p>
	 * If a client uses scenes wich covers a specific part of a window, it may
	 * want to extend GScene and override this method in order to adjust the
	 * viewport according to the new window size. This can be done as follows:
	 * 
	 * <pre>
	 ...
	 * 
	 * @param dx
	 *            Resize fraction in x direction.
	 * @param dy
	 *            Resize fraction in y direction.
	 */
	protected void resize(double dx, double dy) {
		if (isViewportFixed_)
			return;
	 ...
	 * 
	 * @param zoomFactor
	 *            Zoom factor. Zoom in with factor < 1.0 and out with factor >
	 *            1.0.
	 */
	 ...
	 * 
	 * @param x
	 *            X coordinate of fixed point during zoom.
	 * @param y
	 *            Y coordinate of fixed point during zoom.
	 * @param zoomFactor
	 *            Zoom factor.
	 */
	 ...
	 * 
	 * @param x0
	 *            X value of first corner of zoom rectangle.
	 * @param y0
	 *            Y value of first corner of zoom rectangle.
	 * @param x1
	 *            X value of second corner of zoom rectangle.
	 * @param y1
	 *            Y value of second corner of zoom rectangle.
	 */
	 ...
	 * 
	 * @param w0
	 *            First world coordinate of zoom area [x,y,z].
	 * @param w1
	 *            Second world coordinate of zoom area [x,y,z].
	 * @param w2
	 *            Third world coordinate of zoom area [x,y,z].
	 */
	 ...
	 */
	public void unzoom() {
		zoom(initialWorldExtent_.get(0), initialWorldExtent_.get(1),
	 ...
	 * 
	 * @param isAnnotationValid
	 *            True if the annotation of this scene is valid false otherwise.
	 */
	...
	/**
	 * Compute positions of all AWT components (GComponent) elements in this
	 * scene.
	 */
	 ...
	 * 
	 * @param positionals
	 *            Positionals to compute positions of.
	 */
	 ...
	 * 
	 * @param positional
	 *            Positional to compute position for.
	 */
	...
	/**
	 * Instruct this scene to update and respond to the specified scrollbars
	 * during zoom.
	 * <p>
	 * <b>NOTE I:</b> The client application is responsible for laying out the
	 * scrollbars in the AWT/Swing GUI. The scrollbars should have no access
	 * listeneres nor logic added, as this is controlled by the GScene through
	 * the internal GScrollHandler object.
	 * <p>
	 ...
	 * contains scroll logic that interfer with the internal GScene logic. The
	 * correct approach is to create horizontal and vertical JScrollBar
	 * explicitly.
	 * <p>
	 * Specifying both horizontal and vertical scrollbar as <em>null</em> turns
	 * off scroll handling in this scene.
	 * 
	 * @param hScrollBar
	 *            Horizontal scrollbar (or null if a horizontal scrollbar is not
	 *            used).
	 * @param hScrollBar
	 *            Vertical scrollbar (or null if a vertical scrollbar is not
	 *            used).
	 */
