...
public class FileDlpUtil {
	...
	public static void main(String[] args) {
		FileDlpUtil
				.decryptFile(
						"G:\\halo_file\\296557925\\FileRecv\\DP-FSSC-性能测试报告-报账平台-V1.0.docx",
						"G:\\halo_file\\296557925\\FileRecv\\DP-FSSC-性能测试报告-报账平台-V2.0.docx");

		System.out.println(FileDlpUtil.isDynamicDecrypt("d:\\桌面\\tmp001.xlsx"));
	}
}
